...
public class DriveConstants {
     ...
     */
    public static double WHEEL_RADIUS = 0.1; // in
    public static double GEAR_RATIO = 1.0; // output (wheel) speed / input (motor) speed
    public static double TRACK_WIDTH = 0.38227; // in
