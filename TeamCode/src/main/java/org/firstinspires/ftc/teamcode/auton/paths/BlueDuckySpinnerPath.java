...
@Config
public class BlueDuckySpinnerPath extends SequentialCommandGroup {
    ...
    public BlueDuckySpinnerPath(MecanumDriveSubsystem drive, DuckySpinnerSubsystem duckySpinnerSubsystem) {
